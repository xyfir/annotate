...
`Automatically generated annotations for **${bt}** by **${by}**.`;
  ...
  try {
    ...
    res = await request
      ...
      .send({
        ...
        identifiers: (typeof book.identifiers == 'object'
          ? book.identifiers
          : undefined)
      });

    if (res.body.error) throw 'Could not create book on xyAnnotations';
    ...
    if (res.body.error) throw 'Could not create set on xyAnnotations';
    return +res.body.id;
  }
  catch (err) {
